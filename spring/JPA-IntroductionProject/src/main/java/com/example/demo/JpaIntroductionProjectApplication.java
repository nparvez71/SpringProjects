...
public class JpaIntroductionProjectApplication {
	private static final Logger log = LoggerFactory.getLogger(JpaIntroductionProjectApplication.class);
	public static void main(String[] args) {
		SpringApplication.run(JpaIntroductionProjectApplication.class, args);
	}	
	@Bean
